...
<div class="g-col-12">
    <div class=" d-flex align-items-center h-10 mb-10">
        <h2 class=" me-5 animate__animated animate__backInRight" style="font-size:25px;font-weight:800;color:#fca503;margin-top:20px;">
...
<script>
  var service_location = "{{$service_location}}";
    var firebaseConfig = {
